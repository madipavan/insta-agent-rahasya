...
class AppConfig:
    ...
    script_min_seconds: int = 65
    script_max_seconds: int = 82
...
def load_config(config_path: Path | None = None) -> AppConfig:
    ...
    config = AppConfig(
        ...
        script_min_seconds=raw.get("script_min_seconds", 65),
        script_max_seconds=raw.get("script_max_seconds", 82),
    ...
    config.meta_access_token = os.getenv("META_ACCESS_TOKEN", "")
    config.meta_ig_user_id = os.getenv("META_IG_USER_ID", "")
    config.meta_page_id = os.getenv("META_PAGE_ID", "")
